  ...
  <div class>
      ...
      <div class="container">
        <div class="row section-block align-items-center">
          <div class="col">
            ...
            <a href="#promotions" class="btn btn-primary font-weight-bold">Ver menu</a>
          </div>
          <div class="col"></div>
        </div>
      </div>
    ...
    <section id="our-menu" class="section-block section-block__menu row">
      <div class="container">
        ...
        <div class="row justify-content-around my-menu">
          <div
            class="col-4 orders-menu d-flex justify-content-center align-items-center my-5"
